...
<div class="container">
	...
	<div class="row">
		<div class="sm-12">
			<form class="cadastro" id="cadastro_noticias_anexo" action="/adm/mvc/model/noticiasAnexosDAO.php" method="POST" enctype="multipart/form-data" >
				...
				<div class="form-row align-items-center">
						<div class="input-group mb-3">
							...
							<input type="number" disabled data-bind="value:replyNumber" class="form-control" id="inlineFormInputGroupcodigo" placeholder="Código Notícia" name="id_noticia"     value="<?php if(issetParameter("id_noticia")) echo getParameter("id_noticia"); ?>">
						...
						<div class="input-group mb-3">
							<label class="sr-only" for="conteudo_noticia_anexo">Notícia</label>
							<textarea type="text" class="form-control ckeditor"   id="conteudo_noticia_anexo" placeholder="Conteúdo da Notícia" name="conteudo_noticia_anexo"></textarea>
							<div class="input-group-append">								
