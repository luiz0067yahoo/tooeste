...
<div class="container">
	...
	<div class="row">
		<div class="sm-12">
			<form class="cadastro" id="cadastro_album" action="/adm/mvc/model/fotosDAO.php" method="POST" enctype="multipart/form-data">
				...
				<div class="form-row align-items-center">
						...
						<div class="input-group mb-3">
							...
							<select chave="id" valor="nome" modelo="album_fotos" class="form-control selectAjax" id="inlineFormInputGroupalbum" placeholder="Album" name="id_album">
								<option value=""></option>
							<select>
							<div class="input-group-append">								
						...
						<div class="input-group mb-3">
							...
							<input type="hidden" name="foto_path" value="album">
							<div class="input-group-append">								
