...
<div class="container">
	...
	<div class="row">
		<div class="sm-12">
			<form class="cadastro" id="cadastro_anuncio" action="/mvc/controller/ControllerAnuncios.php" method="POST" enctype="multipart/form-data">
				...
				<div class="form-row align-items-center">
						...
						<div class="input-group mb-3">
							...
							<input class="form-control" id="inlineFormInputGroupfotoexpandida" placeholder="Foto do Anuncio Expandido" name="fotoexpandida[]" type="file" multiple accept="image/jpeg">
							<input type="hidden" name="fotoexpandida_formats" value="160x120,320x240,640x480,480x640,800x600,1024x768,1366x768">
							<input type="hidden" name="fotoexpandida_path" value="anuncio">
							<div class="input-group-append">								
								<button name="buscar" type="button" class="btn btn-primary buscarcampo buscarfotoexpandida d-none"><i class="fa fa-search" aria-hidden="true"></i></button	>
							</div>
						</div>
