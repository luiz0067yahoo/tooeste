...
<div class="container">
	...
	<div class="row">
		<div class="sm-12">
			<form class="cadastro" id="cadastro_anuncio" action="/mvc/model/anunciosFotosDAO.php" method="POST" enctype="multipart/form-data">
				...
				<div class="form-row align-items-center">
						...
						<div class="input-group mb-3">
							...
							<input type="number" disabled data-bind="value:replyNumber" class="form-control" id="inlineFormInputGroupcodigoanuncios" placeholder="Código anúncios" name="id_anuncios">
							<div class="input-group-append">								
								<button name="buscar" type="button" class="btn btn-primary buscarcampo buscarcodigo d-none"><i class="fa fa-search" aria-hidden="true"></i></button	>
							</div>
						</div>
						...
						<div class="input-group mb-3">
							...
							<input type="hidden" name="foto_path" value="anuncio_fotos">
							<div class="input-group-append">								
