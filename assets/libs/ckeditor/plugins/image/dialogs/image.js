					...
					elements: [ {
						...
						children: [ {
							...
							children: [ {
								...
								onLoad: function() {
									var dialog = this.getDialog();
									var div_id=dialog.getContentElement('info','txtUrl').domId;
									var txtUrl=$('#'+div_id).find('input').attr('id');
									$('#_explorador').attr('target','#'+txtUrl);
								    $('#'+txtUrl).blur(function(){
								        var newUrl=$(this).val();
                                        CKEDITOR.document.getById( previewImageId ).setAttribute( 'src', newUrl );
								...
								validate: CKEDITOR.dialog.validate.notEmpty( editor.lang.image.urlMissing )
							...
							
									{
										...
										type: 'html',
										html: 	
										'<div onclick="top.w2desktop.popup(this,w2desktop.getPopupID());" style="float:left;">\n'+
										'	<img class="icon_32" src="https://raw.githubusercontent.com/KDE/oxygen-icons/bff159d338fe08be09146a5ee17b9b6efa8a2c8d/32x32/apps/system-file-manager.png">\n '+
										'	<a id="_explorador" target="#url" href="/admin/apps/explorer" onclick="return false;" modal="true" style="display: none">Explorer</a>\n'+
										'</div>',
										'default': '',
									},
									{
